...
const AssignmentListAdmin = (props) => {
  ...
  useEffect(() => {
    fetchData(props.searchQuery); // Fetch data whenever searchQuery changes
  }, [currentPage, props.searchQuery]); // Include searchQuery in the dependency array
  const nextPage = () => {
  ...
  return (
    <>
      <div className='bg-[--gray100] w-[1200px] max-h-[932px]'>
        <div className='MiddleArea w-[1200px]  relative bg-[--gray300] '>
          <div className='Table max-h-[745px] left-[40px] top-[48px] absolute rounded-lg flex-col justify-start items-start flex'>
            <div className='HeadTableContainer self-stretch bg-gray-200 justify-start items-start flex'>
            ...
            {assignmentList.map((assignment) => {
              return (
                <>
                  <div className='Table self-stretch bg-white border-b border-gray-100 justify-start items-start flex'>
            ...
            <div className='pagination flex justify-center items-center space-x-4 mt-6 self-center'>
              <button
                ...
                className={`border-none px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-full focus:outline-none flex items-center ${
